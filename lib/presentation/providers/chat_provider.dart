...
class ChatProvider extends ChangeNotifier{
  ...
  List<Message> messageList = [
    Message(text: 'Hola Ader', fromWho: FromWho.me, timestamp: DateTime.now()),
    Message(text: 'Lloras porque reprobaste topicos?', fromWho: FromWho.me, timestamp: DateTime.now())
  ];
